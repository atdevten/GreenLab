        ...
        "/api/v1/channels": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Workspace ID (required if device_id not provided)",
                        "name": "workspace_id",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/http.FieldResponse"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.CreateFieldRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.UpdateFieldRequest"
                        }
                    }
                ],
                "responses": {
